...
#include "../SolidGameEngine/Graphics/core/Texture.hpp"
...
struct UserData
{
	...
	Solid::Graphics::Texture2D texture;
...
int main(int argc, char* argv[])
{
	...
	//ud->texture.loadFromFile("resources/Nanachi.png");
	ud->texture.loadFromFile("resources/Nanachi2.jpg");
	//ud->texture.loadFromFile("resources/Nanachi3.jpg");
