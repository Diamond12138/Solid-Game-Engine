...
namespace Solid
{
	namespace Graphics
	{
		class Sprite : public Transform, public Renderable
		{
			...
			public:
				Sprite(GLsizei vertex_count = 0,DrawMode draw_mode = DrawMode::TRIANGLES,DrawMethod draw_method = DrawMethod::ARRAYS,GLint vertex_first = 0,GLenum elements_type = GL_UNSIGNED_BYTE)
				...
				Sprite(Transform& transform, GLuint vao,GLsizei vertex_count = 0,DrawMode draw_mode = DrawMode::TRIANGLES,DrawMethod draw_method = DrawMethod::ARRAYS,GLint vertex_first = 0,GLenum elements_type = GL_UNSIGNED_BYTE)
				...
				Sprite(Transform& transform, Renderable& renderable,GLsizei vertex_count = 0,DrawMode draw_mode = DrawMode::TRIANGLES,DrawMethod draw_method = DrawMethod::ARRAYS,GLint vertex_first = 0,GLenum elements_type = GL_UNSIGNED_BYTE)
				...
				Sprite(GLuint vao,GLsizei vertex_count = 0,DrawMode draw_mode = DrawMode::TRIANGLES,DrawMethod draw_method = DrawMethod::ARRAYS,GLint vertex_first = 0,GLenum elements_type = GL_UNSIGNED_BYTE)
